---
title: "HAB-DW-Risk-Viewer Library Creation"
...
path_results <- file.path("inst", "apps", "HAB-DW-Risk-Viewer", "results")
...
path_shiny <- file.path("inst", "apps", "HAB-DW-Risk-Viewer")
fn_copy    <- "remove.txt"
